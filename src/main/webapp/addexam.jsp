...
.smart-green input[type="text"],.smart-green input[type="datetime-local"], .smart-green input[type="email"], .smart-green textarea, .smart-green select {
    color: #555;
    height: 30px;
    line-height:15px;
    width: 100%;
...
<form action ="addexam" class="smart-green" method="post">
<h3>Enter Exam details to be added:</h3>
   Exam Topic:<nbsp>
	<input type="text" name="topic" required><br><br>
   Exam Date and Time:<nbsp>
