...
<form action ="addquestion" class="smart-green" method="post">
  ...
  <input type="text" name="topic" required><br><br>
   Enter Sub Topic:<br><br>
  <input type="text" name="subtopic" required><br><br>
   Enter Level:<br><br>
