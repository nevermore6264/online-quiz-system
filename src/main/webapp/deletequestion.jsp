...
<body>
<form action ="actualdelete" class="smart-green" method="post">
<c:set var="count" value="0" scope="page" />
<c:forEach var="table" items='${requestScope.qlist}'>
	  <input type="checkbox" value =${table.getQuestionid()} name = "selected"><nbsp>
	  <c:set var="count" value="${count + 1}" scope="page"/>
	  <c:out value="${count}"></c:out><nbsp>
	  <c:out value="${table.getQuestion()}"></c:out><br>
	   <c:out value="    Topic: "></c:out><c:out value="${table.getTopic()}"></c:out><br>
